...
('perm-btn-project-archive','button:projects:archive','项目管理 / 归档项目','按钮权限','归档','项目管理'),
('perm-btn-project-members','button:project-detail:edit-members','项目详情 / 维护成员','按钮权限','维护成员','项目详情'),
('perm-btn-stage-create-task','button:stage-detail:create-task','阶段详情 / 新建任务','按钮权限','新建任务','阶段详情'),
('perm-btn-stage-blocker-help','button:stage-detail:blocker-help','阶段详情 / 卡点求助','按钮权限','卡点求助','阶段详情'),
('perm-btn-stage-file-publish','button:stage-detail:publish-file','阶段详情 / 发布资料','按钮权限','发布到项目资料区','阶段详情'),
('perm-btn-stage-record-publish','button:stage-detail:publish-record','阶段详情 / 发布留言','按钮权限','发布留言','阶段详情'),
('perm-btn-customer-delete','button:customers:delete','客户管理 / 删除客户','按钮权限','删除客户','客户管理'),
('perm-btn-customer-detail','button:customers:view-detail','客户管理 / 查看详情','按钮权限','客户详情','客户管理'),
('perm-btn-customer-contact','button:customer-detail:add-contact','客户详情 / 新增联系人','按钮权限','新增联系人','客户详情'),
('perm-btn-customer-material','button:customer-detail:upload-material','客户详情 / 上传资料','按钮权限','上传资料','客户详情'),
('perm-btn-customer-followup','button:customer-detail:add-followup','客户详情 / 新增跟进','按钮权限','新增跟进','客户详情'),
('perm-btn-customer-order','button:customer-detail:create-order','客户详情 / 新建订单','按钮权限','下单','客户详情'),
('perm-btn-task-save','button:tasks:save','任务管理 / 保存任务','按钮权限','保存任务','任务管理'),
('perm-btn-task-detail-save','button:task-detail:save','任务详情 / 保存任务','按钮权限','保存任务','任务详情'),
('perm-btn-task-comment','button:task-detail:publish-comment','任务详情 / 发布评论','按钮权限','发布评论','任务详情'),
('perm-btn-order-delete','button:orders:delete','订单管理 / 删除订单','按钮权限','删除订单','订单管理'),
('perm-btn-order-history','button:orders:view-history','订单管理 / 查看修改记录','按钮权限','查看修改记录','订单管理'),
('perm-btn-template-create','button:templates:create','流程模板 / 新建模板','按钮权限','新建模板','流程模板'),
('perm-btn-template-edit','button:templates:edit','流程模板 / 编辑模板','按钮权限','编辑模板','流程模板'),
('perm-btn-template-toggle','button:templates:toggle','流程模板 / 启用停用','按钮权限','启用 / 停用','流程模板'),
('perm-btn-customer-status-create','button:customer-statuses:create','客户状态配置 / 新增','按钮权限','新增','客户状态配置'),
('perm-btn-customer-status-edit','button:customer-statuses:edit','客户状态配置 / 编辑','按钮权限','编辑','客户状态配置'),
('perm-btn-customer-status-toggle','button:customer-statuses:toggle','客户状态配置 / 启用停用','按钮权限','启用 / 停用','客户状态配置'),
('perm-btn-customer-status-delete','button:customer-statuses:delete','客户状态配置 / 删除','按钮权限','删除','客户状态配置'),
('perm-btn-customer-level-create','button:customer-levels:create','客户等级配置 / 新增','按钮权限','新增','客户等级配置'),
('perm-btn-customer-level-edit','button:customer-levels:edit','客户等级配置 / 编辑','按钮权限','编辑','客户等级配置'),
('perm-btn-customer-level-toggle','button:customer-levels:toggle','客户等级配置 / 启用停用','按钮权限','启用 / 停用','客户等级配置'),
('perm-btn-customer-level-delete','button:customer-levels:delete','客户等级配置 / 删除','按钮权限','删除','客户等级配置'),
('perm-btn-order-type-create','button:order-types:create','订单类型配置 / 新增','按钮权限','新增','订单类型配置'),
('perm-btn-order-type-edit','button:order-types:edit','订单类型配置 / 编辑','按钮权限','编辑','订单类型配置'),
('perm-btn-order-type-toggle','button:order-types:toggle','订单类型配置 / 启用停用','按钮权限','启用 / 停用','订单类型配置'),
('perm-btn-order-type-delete','button:order-types:delete','订单类型配置 / 删除','按钮权限','删除','订单类型配置'),
('perm-btn-task-status-create','button:task-statuses:create','任务状态配置 / 新增','按钮权限','新增','任务状态配置'),
('perm-btn-task-status-edit','button:task-statuses:edit','任务状态配置 / 编辑','按钮权限','编辑','任务状态配置'),
('perm-btn-task-status-toggle','button:task-statuses:toggle','任务状态配置 / 启用停用','按钮权限','启用 / 停用','任务状态配置'),
('perm-btn-task-status-delete','button:task-statuses:delete','任务状态配置 / 删除','按钮权限','删除','任务状态配置'),
('perm-btn-task-transition-add','button:task-statuses:add-transition','任务状态配置 / 新增流转','按钮权限','新增流转','任务状态配置'),
('perm-btn-task-transition-delete','button:task-statuses:delete-transition','任务状态配置 / 删除流转','按钮权限','删除流转','任务状态配置')
